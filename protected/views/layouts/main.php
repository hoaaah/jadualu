	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Pegawai', 'url'=>array('/RefPegawai/index'), 'visible'=>!Yii::app()->user->isGuest),						
				array('label'=>'SIMOKU', 'url'=>array('/Ppud/index'), 'visible'=>!Yii::app()->user->isGuest),	
				array('label'=>'Cuti', 'url'=>array('/TcutiTahunan/'), 'visible'=>!Yii::app()->user->isGuest),						
